  ...
  return (
    <footer className="px-3 pb-3 md:px-4 md:pb-4">
      <div className="container mx-auto px-0">
        <div className="theme-panel overflow-hidden rounded-[2rem] border border-white/10 px-5 py-10 md:px-8 md:py-12">
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.75fr_0.75fr_1fr]">
            <div className="space-y-5">
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-[0.72rem] uppercase tracking-[0.3em] text-accent/82">
              ...
              <div className="flex items-center gap-3">
                <Link
                  ...
                  className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-primary/72 transition-all duration-300 hover:-translate-y-0.5 hover:border-accent/40 hover:text-accent"
                >
                  <Instagram className="h-4 w-4" />
                </Link>
                <DownloadCatalogButton
                  variant="outline"
                  className="h-11 rounded-full border-white/14 bg-white/[0.04] px-5 text-[0.72rem] uppercase tracking-[0.26em] text-primary hover:bg-white/[0.09]"
                />
              </div>
            </div>
            ...
            <div className="rounded-[1.75rem] border border-white/10 bg-white/[0.03] p-6">
              <p className="text-[0.72rem] uppercase tracking-[0.3em] text-accent/82">{t('footer.contact_us')}</p>
          ...
          <div className="mt-10 flex flex-col gap-3 border-t border-white/10 pt-6 text-sm text-primary/56 md:flex-row md:items-center md:justify-between">
