  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'gold-glow': {
          '0%, 100%': {
            boxShadow: '0 0 5px 0px hsl(var(--accent) / 0.6)',
          },
          '50%': {
      ...
      animation: {
        ...
        'fade-in': 'fade-in 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards',
        'fade-out': 'fade-out 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards',
